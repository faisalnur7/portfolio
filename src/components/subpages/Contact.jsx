        ...
        <section className={`bg-${bg_color} pb-0 shadow-lg py-4 lg:py-12 px-6 lg:px-8`}>
            <div className="container max-w-screen-xl mx-0 px-auto  lg:mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
                <div className="w-full flex justify-center pt-0 pb-0 lg:pt-4 lg:pb-8">
                    <h1 className={`text-white text-3xl lg:text-5xl font-extrabold hover:underline`}>Contact</h1>
                </div>
                <div className="container mx-auto">
                    <div>
                        <h4 className={`text-white mt-4 lg:mt-12 text-lg lg:text-2xl font-semibold`}>Connect with me</h4>
                    ...
                    <div className="flex justify-between items-center md:items-stretch flex-col md:flex-row pb-24">
                        ...
                        <div className="w-full flex flex-col md:items-end mt-12 md:mt-6">
                            <h1 className={`text-white text-xl lg:text-3xl font-bold`}>Email</h1>
                            <a href="mailto:md.faisalnur55@gmail.com" className="mb-12 mt-4 font-semibold text-white block">
                                md.faisalnur55@gmail.com
                            </a>
                            <h1 className={`text-white text-xl lg:text-3xl font-bold`}>Address</h1>
                            ...
                            <h1 className={`text-white text-xl lg:text-3xl font-bold`}>Social</h1>
                            <ul className="flex">
